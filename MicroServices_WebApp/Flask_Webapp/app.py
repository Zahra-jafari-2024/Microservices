...
ai_face_analysis_microservice_url = "http://127.0.0.1:8000/faceanalysis"
...
def BMR():
    ...
    print(response.json())
    return render_template("resultbmr.html",bmi=response.json())
        ...
        if request.method=="GET":
            ...
            if my_image.filename == "":
                ...
                if my_image and allowed_file(my_image.filename):
                    ...
                    return render_template("result.html",genders=genders,ages=ages)                
